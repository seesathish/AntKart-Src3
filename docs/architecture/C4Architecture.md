...
![Level 1 — System Context](c4-level1-system-context.png)

![Legend](c4-legend.png)
...
![Level 2 — Container](c4-level2-container.png)
...
![Level 3 — Component: AK.Order](c4-level3-order-components.png)
...
![Order Flow — Dynamic View](c4-order-flow-dynamic.png)
