...
## Step 6 — docs/guides/eventbus-concepts.md
...
grep -A 3 "exchange\|queue" docs/guides/eventbus-concepts.md | head -40
```
...
## Step 8 — docs/guides/observability-concepts.md
...
- [ ] `docs/guides/observability-concepts.md` → Per-service log events table
