        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SavedCardToken = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    RazorpayCustomerId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    RazorpayTokenId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    CardNetwork = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_saved_cards_RazorpayTokenId",
                table: "saved_cards",
                column: "RazorpayTokenId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_saved_cards_UserId",
                table: "saved_cards",
                column: "UserId");
        }
