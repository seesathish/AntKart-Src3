...
dependency "key_vault" {
  ...
  mock_outputs = {
    id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-antkart-qa-eastus/providers/Microsoft.KeyVault/vaults/kv-antkart-qa"
  }
  mock_outputs_allowed_terraform_commands = ["init", "plan", "validate"]
}
...
dependency "servicebus" {
  ...
  mock_outputs = {
    id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-antkart-qa-eastus/providers/Microsoft.ServiceBus/namespaces/sb-antkart-qa"
  }
  mock_outputs_allowed_terraform_commands = ["init", "plan", "validate"]
}
...
dependency "eventgrid" {
  ...
  mock_outputs = {
    id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-antkart-qa-eastus/providers/Microsoft.EventGrid/topics/evgt-antkart-qa"
  }
  mock_outputs_allowed_terraform_commands = ["init", "plan", "validate"]
}
