...
dependency "networking" {
  ...
  mock_outputs = {
    subnet_ids = {
      "aks"               = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-antkart-qa-eastus/providers/Microsoft.Network/virtualNetworks/vnet-antkart-qa-eastus/subnets/aks"
      "private-endpoints" = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-antkart-qa-eastus/providers/Microsoft.Network/virtualNetworks/vnet-antkart-qa-eastus/subnets/private-endpoints"
      "gateway"           = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-antkart-qa-eastus/providers/Microsoft.Network/virtualNetworks/vnet-antkart-qa-eastus/subnets/gateway"
    }
  }
  mock_outputs_allowed_terraform_commands = ["init", "plan", "validate"]
}
...
dependency "container_registry" {
  ...
  mock_outputs = {
    id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-antkart-qa-eastus/providers/Microsoft.ContainerRegistry/registries/acrantkartqa"
  }
  mock_outputs_allowed_terraform_commands = ["init", "plan", "validate"]
}
...
dependency "observability" {
  ...
  mock_outputs = {
    workspace_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-antkart-qa-eastus/providers/Microsoft.OperationalInsights/workspaces/log-antkart-qa"
  }
  mock_outputs_allowed_terraform_commands = ["init", "plan", "validate"]
}
